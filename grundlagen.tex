...
Bisher sind wir den Klassen \lojb{COI} und \lojb{UI} begegnet. \lojb{UI} umfasst Attitudinals und Verwandte, \lojb{COI} Begr"ussungen und "Ahnliches (so geh"ort \lojb{mi'e} auch dazu).
