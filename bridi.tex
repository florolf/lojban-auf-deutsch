...
do kurji ko
\end{quote}
alle ``k"ummere dich um dich!", letztlich hat hier \lojb{ko} im Vergleich zu \lojb{do} nur eine diesen Platz betonende Funktion.
...
\lojb{ninmu} bezeichnet ein weibliches Lebewesen, nicht mehr} beschreibe'' oder schlicht: ``eine Frau''. \lojb{le} ist jedoch nicht absolut,
...
anderen, m"achtigeren Weg, Besitz anzuzeigen, den wir sp"ater noch betrachten werden). Beispielsweise w"aren \lojb{le mi krace} ``mein Auto'' und
